...
public class MarkdownFileImportScheduler  {
	...
	public MarkdownFileImportScheduler(MarkdownParserService markdownParserService, GithubLinkService githubLinkService) {
	...
	public void processGithubPage(InputConfig config) {
...
//					}
					...
					BranchRootInfo branchRootInfo = BranchRootInfo.createBranchRootInfo(config.getRootPath(), configPages, githubData,
